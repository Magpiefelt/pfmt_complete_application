-- TEAM A FEATURE ENHANCEMENTS FOR TEAM B SCHEMA
...
CREATE TABLE file_uploads (
    ...
    entity_type VARCHAR(50), -- 'project', 'contract', 'report', 'gate_meeting', 'task'
    entity_id UUID,
...
CREATE INDEX idx_change_orders_change_order_number ON change_orders(change_order_number);
...
-- Sample contract statuses for reference
