...
CREATE TABLE project_wizard_sessions (
    ...
    -- Link the wizard session to a project template when one is chosen.  Using
    -- UUID ensures type consistency with project_templates.id.
...
-- =====================================================
-- NOTE: The legacy SERIAL-based definitions for project templates and wizard tables have
-- been removed. We now use UUID-based versions defined earlier in this schema. Keeping
-- a single set of definitions prevents type mismatches and ensures the wizard operates
-- correctly.
